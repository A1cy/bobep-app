...
var swigo = (function () {
  ...
  /* Mini shop-filter Function*/
  var handleCartPannel = function () {
    $(".cart-panel-btn").on("click", function () {
      $(".cart-filter").addClass("show");
    });
    $(".cart-panel-close-btn").on("click", function () {
      $(".cart-filter").removeClass("show");
    });
  };
  ...
  var dzTheme = function () {
    ...
    jQuery(".sidenav-nav .navbar-nav > li > a")
    ...
    jQuery(".sidenav-nav .navbar-nav > li > a, .sidenav-nav .sub-menu > li > a")
      ...
      .on("click", function (e) {
        if (jQuery(this).hasClass("open")) {
          ...
          if (
            jQuery(this).parent("li").children(".sub-menu,.mega-menu").length >
            0
          ) {
            e.preventDefault();
  ...
  var handleSelectpicker = function () {
    if (
      ...
      jQuery.isFunction($.fn.selectpicker)
    ) {
  ...
  var handleTempusDominus = function () {
    if (jQuery("#datePickerOnly").length > 0) {
      const td = new tempusDominus.TempusDominus(
        document.getElementById("datePickerOnly"),
        {
          display: {
            viewMode: "calendar",
            components: {
    ...
    if (jQuery("#timePickerOnly").length > 0) {
      new tempusDominus.TempusDominus(
        document.getElementById("timePickerOnly"),
        {
          display: {
            viewMode: "clock",
            components: {
