  ...
  var e = $(window).width(),
    ...
    l = function () {
      e <= 991 &&
        ...
        jQuery(
          ".sidenav-nav .navbar-nav > li > a, .sidenav-nav .sub-menu > li > a"
        )
          .unbind()
          .on("click", function (e) {
    ...
    d = function () {
      jQuery(window).on("scroll", function () {
        if (
          "sticky-no" !== jQuery("body").attr("data-headerposition") &&
          ...
          jQuery(document).on("scroll", function () {
            ...
            jQuery(".navbar-scroll .scroll").each(function () {
              var n,
                i = jQuery(this);
              jQuery(i.attr("href")),
                parseInt(jQuery(this.hash).offset().top, 10) - t - 30 <= e &&
      ...
      jQuery("a").on("mousemove", function (e) {
        ...
        ((r) => {
          (window.onmousemove = (e) => {
            (n = void 0 != e.clientX ? e.clientX : -100),
              (i = void 0 != e.clientY ? e.clientY : -100);
          }),
            ...
            u = () => {
              void 0 != n &&
                ...
                (t.style.transform = `translate(${
                  a - (l ? d("ringClickSize") : d("ringSize"))
                }px, ${o - (l ? d("ringClickSize") : d("ringSize"))}px)`),
